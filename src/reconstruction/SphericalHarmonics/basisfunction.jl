...
"""
    bfuncOut = basisfunc(x::AbstractVector{T}, y::AbstractVector{T}, z::AbstractVector{T}, terms::AbstractVector{Int}) where {T<:AbstractFloat}
...
julia> bfuncOut = basisfunc(x, y, z, terms)
```
"""
function basisfunc(x::AbstractVector{T}, y::AbstractVector{T}, z::AbstractVector{T}, terms::AbstractVector{Int}) where {T<:AbstractFloat}
    """
...
function basisfunc(x::AbstractVector{T}, y::AbstractVector{T}, z::AbstractVector{T}, term::Int64) where {T<:AbstractFloat}
    # Switch-case equivalent for selecting basis function
    if term == 1
        bfunc = x.*0 .+ 1
    elseif term == 2
