...
function csm_Gaussian_grid_block_pha(
    ...
    csm = zeros(ComplexF32, (nX, nY, nCoil));
    mag = zeros(ComplexF32, (nX, nY));
    if use_gpu
        X = X |> gpu
        Y = Y |> gpu
        mag = mag |> gpu
...
"""
v1.0 version of csm_Gaussian_grid_block, real-valued
"""
function csm_Gaussian_grid_block(
    nX::Int64, 
    nY::Int64, 
...
"""
inital version of csm_Gaussian_grid_block, real-valued
"""
function csm_Gaussian_grid_block_v0(
    nX::Int64, 
    nY::Int64, 
    nCoil::Int64;     
    nRow=nothing,
