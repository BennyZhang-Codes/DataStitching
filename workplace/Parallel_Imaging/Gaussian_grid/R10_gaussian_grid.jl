...
outpath = "$(@__DIR__)/workplace/Parallel_Imaging/debug/out/R10_gaussian_grid_pha_fan_cs"; if ispath(outpath) == false mkpath(outpath) end     # output directory
##############################################################################################
# Setup
##############################################################################################
T = Float64;
...
sim_params["Nblocks"] = 100;
sim_params["Nthreads"] = 160;
##### 4. simulate
