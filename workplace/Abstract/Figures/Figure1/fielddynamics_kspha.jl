...
fig.savefig("$(outpath)/Fig_kspha_r$(r).png", dpi=300, bbox_inches="tight", transparent=true, pad_inches=0)
fig.savefig("$(outpath)/Fig_kspha_r$(r).svg", dpi=300, bbox_inches="tight", transparent=true, pad_inches=0)
