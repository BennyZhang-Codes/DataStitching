...
fig.savefig("workplace/Abstract/out/Fig_bfield_r$(r).png", dpi=300, bbox_inches="tight", transparent=true)
fig.savefig("workplace/Abstract/out/Fig_bfield_r$(r).svg", dpi=300, bbox_inches="tight", transparent=true)
