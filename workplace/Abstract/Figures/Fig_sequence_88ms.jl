...
dfc           = matread(dfc_file)["skopeStitched"]' * 1e-3; # mT, mT/m, mT/m² => T, T/m, T/m²
...
hoseq.GR_dfc[:,5] = GR_dfc;              # "5" is the index of the readout block in the spiral sequence
plot_seq(hoseq)
...
fig.savefig("workplace/Abstract/out/Fig_sequence_150_r$(r).png", dpi=300, bbox_inches="tight", transparent=true)
fig.savefig("workplace/Abstract/out/Fig_sequence_150_r$(r).svg", dpi=300, bbox_inches="tight", transparent=true)