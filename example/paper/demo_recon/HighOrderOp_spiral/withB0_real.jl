...
# 2. phantom
obj = brain_phantom2D(BrainPhantom(); ss=simtype.ss, location=0.8, B0_type=:real, B0_file=:B0_medianfiltered_r4); info(obj)
...
ref = B0_scale/100*brain_phantom2D_reference(BrainPhantom(); ss=simtype.ss, location=0.8,target_fov=(150, 150), target_resolution=(1,1),
