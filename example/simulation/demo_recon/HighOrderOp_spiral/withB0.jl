...
# 2. phantom
obj = brain_phantom2D(BrainPhantom(); ss=simtype.ss, location=0.8, B0map=:quadratic, maxOffresonance=maxOffresonance); info(obj)
...
ref = brain_phantom2D_reference(BrainPhantom(); ss=simtype.ss, location=0.8,target_fov=(150, 150), target_resolution=(1,1),
