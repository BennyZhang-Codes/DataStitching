using KomaHighOrder, MRIReco, MRICoilSensitivities
import KomaHighOrder.MRIBase: AcquisitionData


seq_file = "$(@__DIR__)/demo/muti-echo_GRE/gres6e_fov200_200_bw556.seq"                 # *.seq file is the pulseq's sequence file
mrd_file = "$(@__DIR__)/demo/muti-echo_GRE/meas_MID00066_FID49933_pulseq_v0_gres6.mrd"  # *.mat file contains the dynamic field data from both stitching method and the standard method.
