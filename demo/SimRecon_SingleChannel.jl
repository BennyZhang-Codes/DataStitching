...
simtype = SimType(B0=true, T2=false, ss=5)                       # setting for Simulation: [B0=true] turn on B0, [T2=false] turn off T2, [ss=5] set phantom down-sample factor to 5
BHO = BlochHighOrder("111", true, true)                          # setting for Simulation: ["111"] turn on all order terms of dynamic field change. turn on Δw_excitation, Δw_precession
