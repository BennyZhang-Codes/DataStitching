...
csm_param = Dict("csm_type"=>csm_type, "csm_nCoil"=>csm_nCoil, "csm_nRow"=>csm_nRow, "csm_nCol"=>csm_nCol, "csm_nBlock"=>csm_nBlock, "csm_radius"=>csm_radius);
results = Dict("imgs"=>imgs, "labels"=>labels, "csm"=>csm, "csm_param"=>csm_param, "b0"=>b0, "datatime"=>datatime, "snr"=>snr, 
...
MAT.matwrite("$(outpath)/0p3_500_r30_$(csm_nCoil)_ss$(ss)_snr$(snr)_$(solver)_$(iter)_$(regularization)_$(λ).mat", results)
